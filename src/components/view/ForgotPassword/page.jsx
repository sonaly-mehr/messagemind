      ...
      <div className="w-[90%] md:w-2/5 m-auto h-full flex flex-col justify-center relative top-10 z-30">
        <div className="w-full">
          ...
          <div className="box_shaddow bg-white border-[1px] border-solid border-[#F2F4F5] rounded-2xl px-7 md:px-16 pt-10 md:pt-16 pb-10">
            ...
            <p className="para text-center mt-6 mb-4 md:mb-8">Enter the email address associated with your account and we will send you a link to reset your password.</p>
            <form action="">
              ...
              <SubmitButton type="submit" text="Continue" />
            </form>
          </div>
          <Footer />
        </div>
